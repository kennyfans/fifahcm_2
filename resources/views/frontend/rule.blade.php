...
<div class="col-md-12">
    <p>
        Nhằm đem lại sân chơi hấp dẫn và tăng tính giải trí, CLB Fifa online 3 HCM tạo thêm sự kiện dự đoán trúng thưởng đồng hành cùng giải đấu HCM Teams League Seri A cho các bạn trong và ngoài CLB cùng tham gia.
    </p>
    <p>
        Thành phần tham gia dự đoán : tất cả các bạn có account Fifa online 3 ingame hiện đang sinh sống tại khu vực thành phố Hồ Chí Minh.
    </p>
    <p>
    ...
    <p>
        Giải thưởng :
        <ul>
            <li>Hạng 1-5: 5.000.000 EP ( mỗi giải )</li>
            <li>Hạng 6-10: 3.000.000 EP ( mỗi giải )</li>
        </ul>
        <b>( Nếu các người chơi có cùng điểm số thì sẽ ưu tiên người tham gia dự đoán trước )</b>
    </p>
